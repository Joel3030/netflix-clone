	...
	return (
		<div className='relative w-full -[80vw] md:h-[56.25vw] lg:h-[45vw]'>
			<video
				...
				loop
				muted
				className='brightness-50 object-fill w-full h-[80vw] md:h-[56.25vw] lg:has-[45vw]:'
				src='/videos/home.mp4'
			/>
			<div className='flex flex-col justify-end absolute w-full md:w-[36%] px-4 md:px-0 md:left-[4%] z-20 top-0 -bottom-7 md:bottom-[36%]'>
				<div className='pt-24 md:pt-0'>
					...
					<p className='max-w-md mt-2 text-xs md:text-base'>
						Learn how to create a Netflix clone with all its key features, from
						user management to video playback, while uncovering the secrets
						behind a successful streaming platform.
					</p>
